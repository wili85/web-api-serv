...
class Tramite {
	...
	function registrarHt($data){
		...
		$conn = $this->db_b->getConnection();
		$sql = "begin pkg_movstd.regtramite_update(:icodtramite1,:nflgtipodoc1,:icodtrabajadorregistro1,:icodoficinaregistro1,:icodtema1,:ccodtipodoc1,:ffecdocumento1,:cnrodocumento1,:icodremitente1,:casunto1,:cobservaciones1,:nnumfolio1,:nflgenvio1,:ffecregistro1,:nflgestado1,:nflganulado1,:icodtrabajadorsolicitado1,:cnomremite1,:nflgclasedoc1,:ffecfinalizado1,:icantidadcartagarantias1,:cmontocartagarantias1,:icodclasificacion1,:cadena1,:cadena2,:idesqobs, :icodtramiteref1); end;";
		$rs = oci_parse($conn, $sql);
		$icodtramite1=0;
